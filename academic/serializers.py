...
from .models import Teacher, ClassYear, StudentsMedicalHistory, Student, GradeScale, GradeScaleRule, ClassRoom
...
class StudentSerializer(serializers.ModelSerializer):
    ...
    def get_class_level(self, obj):
        ...
        serializer = ClassRoomSerializer(class_level, many=False)
